...
public class GlobalExceptionHandler
    extends ResponseEntityExceptionHandler {
        ...
        /**
         * This method handles {@link MethodArgumentNotValidException} exceptions relating to invalid method parameters (particularly with request bodies)
         * @param ex The actual exception containing the information on the invalid parameter
         * @param request The request for which the method parameter(s) were invalid
         * @return a 500 response or a 400 response depending on whether the violations are for a return value
         */
        @Override
        protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
            HttpHeaders headers, HttpStatusCode status, WebRequest request) {
                int methodParamterIndex = ex.getParameter().getParameterIndex();
                var detailMessageArguments = ex.getDetailMessageArguments();
                Object errorDetail = detailMessageArguments[methodParamterIndex];
        ...
        protected ResponseEntity<Object> handleSpotifyExceptions(SpotifyWebApiException ex, @NonNull WebRequest request) {
            ...
            String responseMessage = "Spotify API Exception: ";
        ...
        /**
         * This method is a general runtime exception handler; it just forwards runtime exceptions
         * @param ex The runtime exception
         * @param request The web request for which an exception was thrown
         * @return
         */
